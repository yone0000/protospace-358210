...
ActiveRecord::Schema.define(version: 2021_05_26_012658) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "user_profile", null: false
    t.string "user_occupation", null: false
    t.string "user_position", null: false
